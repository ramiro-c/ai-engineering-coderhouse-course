...
class RagReference(BaseModel):
    ...
    snippet: str = Field(description="Fragmento del apunte usado como contexto (~200 caracteres)")


class RagResponse(BaseModel):
    text: str = Field(description="Respuesta en español, fundamentada solo en el contexto recuperado")
...
class RagGenerationError(BaseModel):
    ...
    detalle: str = Field(description="Explicación legible de qué falló en el pipeline RAG")
